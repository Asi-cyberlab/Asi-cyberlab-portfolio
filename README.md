...
Built a small secure network in Cisco Packet Tracer to practice IP addressing, routing, VLANs, ACLs, and basic network security.

### Penetration Testing Lab

Created a virtual lab using VirtualBox to learn basic vulnerability assessment and gain hands-on experience with cybersecurity tools.

### Cybersecurity Analysis Lab

Practiced analysing network traffic and security logs using Wireshark to better understand how network activity can be monitored.
